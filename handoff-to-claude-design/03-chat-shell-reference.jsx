        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ flex: 1, overflow: 'hidden', padding: '0 32px 24px', maxWidth: 880, width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
            ...
            <Turn role="COOPR" body={
              <>
                <p style={{ margin: '0 0 12px', fontSize: 14, lineHeight: 1.55, color: 'var(--fg-primary)' }}>The drop happens at <span style={{ fontWeight: 600 }}>0:03</span> and again at <span style={{ fontWeight: 600 }}>0:14</span>. The first cuts <span style={{ fontWeight: 600, color: 'var(--accent-primary)' }}>−14% vs your benchmark</span>. The second is normal mid-attention.</p>
...
Object.assign(window, { HF_ChatDefault, HF_ChatEmpty, HF_ChatActive });
